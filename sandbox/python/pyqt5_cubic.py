...
class ParamcubicFrame(QtWidgets.QFrame):
    ...
    def paintEvent(self, event):
        ...
        p0 = sbnet.point(100,150)
        p1 = sbnet.point(200,250)
        p2 = sbnet.point(250,50)
        p3 = sbnet.point(400,100)
