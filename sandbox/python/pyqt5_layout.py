...
sys.path.insert(1,'/home/poltergeist/home/devel/install/graphfab-trunk/site-packages-py2')

import os
os.chdir('/home/poltergeist/home/devel/install/graphfab-trunk/bin')
...
class Autolayout(QtWidgets.QMainWindow):
    ...
    def openfile(self, filepath):
        ...
        try:
            self.model = graphfab.loadsbml(filepath)
        except:
